...
function Login() {
  ...
  // Forgot Password states (now uses email)
  ...
  if (!showForgotPassword) {
    return (
      <div style={{
        background: "#0a0a0f", color: "white", minHeight: "100vh",
        display: "flex", justifyContent: "center", alignItems: "center",
        fontFamily: "'Segoe UI', Arial, sans-serif", padding: "20px",
      }}>
        <div style={{
          background: "#1a1a2e", padding: "40px", borderRadius: "20px",
          maxWidth: "400px", width: "100%", border: "1px solid #2a2a4a",
          boxShadow: "0 20px 60px rgba(0,0,0,0.8)",
        }}>
          <div style={{ textAlign: "center", marginBottom: "30px" }}>
            <div style={{ fontSize: "40px", marginBottom: "10px" }}>🔐</div>
            <h1 style={{ fontSize: "28px", margin: "0", color: "#fbbf24" }}>Welcome Back</h1>
            <p style={{ color: "#94a3b8", fontSize: "14px", margin: "5px 0 0 0" }}>Login to access exclusive content</p>
          </div>
          ...
          <form onSubmit={handleLogin}>
            <div style={{ marginBottom: "20px" }}>
              ...
              <input
                ...
                style={{
                  ...
                  border: "1px solid #2a2a4a", background: "#0a0a0f", color: "white",
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "25px", fontSize: "14px" }}>
              <label style={{ color: "#94a3b8", cursor: "pointer" }}>
                <input type="checkbox" checked={rememberMe} onChange={() => setRememberMe(!rememberMe)} style={{ marginRight: "8px", accentColor: "#8b5cf6", cursor: "pointer" }} />
                Remember Me
              </label>
              <button type="button" onClick={() => setShowForgotPassword(true)} style={{ background: "none", border: "none", color: "#8b5cf6", cursor: "pointer", fontWeight: "600", fontSize: "14px" }}
            ...
            <button type="submit" disabled={loading} style={{
              ...
              background: loading ? "#4a4a6a" : "linear-gradient(135deg, #8b5cf6, #ec4899)",
        ...
        {step === "otp" && (
          <form onSubmit={handleVerifyOTP}>
            <div style={{ marginBottom: "20px" }}>
              ...
              <input
                ...
                style={{
                  ...
                  border: "1px solid #2a2a4a", background: "#0a0a0f", color: "white",
                  fontSize: "16px", outline: "none", boxSizing: "border-box",
                  textAlign: "center", fontSize: "24px", letterSpacing: "10px",
                }}
                onFocus={(e) => { e.target.style.borderColor = "#8b5cf6"; e.target.style.boxShadow = "0 0 20px rgba(139, 92, 246, 0.2)"; }}
                onBlur={(e) => { e.target.style.borderColor = "#2a2a4a"; e.target.style.boxShadow = "none"; }}
              />
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px", fontSize: "14px" }}>
              ...
              <button type="button" onClick={handleResendOTP} disabled={!canResend} style={{
            ...
            <button type="button" onClick={() => { setStep("phone"); setOtp(""); setError(""); }} style={{
              width: "100%", padding: "10px", marginTop: "10px", borderRadius: "50px",
        ...
        {step === "reset" && (
          <form onSubmit={handleResetPassword}>
            <div style={{ marginBottom: "20px" }}>
              ...
              <input type="password" placeholder="Enter new password (min 6 chars)" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} required minLength="6" style={{
                width: "100%", padding: "12px 15px", borderRadius: "10px",
                border: "1px solid #2a2a4a", background: "#0a0a0f", color: "white",
                fontSize: "16px", outline: "none", boxSizing: "border-box",
              }} />
            ...
            <div style={{ marginBottom: "25px" }}>
              ...
              <input type="password" placeholder="Confirm your new password" value={confirmNewPassword} onChange={(e) => setConfirmNewPassword(e.target.value)} required style={{
                width: "100%", padding: "12px 15px", borderRadius: "10px",
                border: "1px solid #2a2a4a", background: "#0a0a0f", color: "white",
                fontSize: "16px", outline: "none", boxSizing: "border-box",
              }} />
