  ...
  return (
    <div style={{
      ...
      {showBuyCoupons && (
        <div style={{
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <button
              onClick={() => setShowBuyCoupons(false)}
              style={{
          ...
          <p style={{ color: "#94a3b8", fontSize: "13px", margin: "10px 0" }}>
            💡 Like = 2 coupons • Chat = 5 coupons • Sticker = 2 coupons
          </p>
      ...
      <div style={{
        ...
        justifyContent: "space-between",
        alignItems: "center",
        background: subscription ? "linear-gradient(135deg, #064e3b, #065f46)" : "linear-gradient(135deg, #1a1a2e, #16213e)",
        borderRadius: "16px",
        padding: "18px 25px",
        marginTop: "15px",
        ...
        <div>
          ...
          <div style={{
            fontWeight: "bold",
            color: subscription ? "#22c55e" : "#94a3b8",
            fontSize: "16px",
          }}>
        ...
        <div style={{ textAlign: "right" }}>
          ...
          <div style={{
            fontWeight: "bold",
            color: subscription ? "#fbbf24" : "#94a3b8",
            fontSize: "16px",
          }}>
      ...
      <div style={{
        ...
        <button
          style={{
            ...
            borderRadius: "12px",
            border: "none",
            background: !showChat ? "linear-gradient(135deg, #8b5cf6, #7c3aed)" : "transparent",
            color: !showChat ? "white" : "#94a3b8",
            cursor: "pointer",
            fontWeight: "600",
            fontSize: "14px",
            transition: "all 0.3s",
        ...
        <div style={{ marginTop: "20px" }}>
          {!content || content.length === 0 ? (
            <div style={{
              ...
              <h4 style={{ color: "#94a3b8", margin: "10px 0", fontSize: "20px" }}>
                No Content Yet
              </h4>
              <p style={{ color: "#64748b", fontSize: "14px" }}>
                Check back later for exclusive photos and videos!
              </p>
            </div>
          ) : (
            <>
              ...
              {hasPhotos && (
                <div style={{ marginBottom: "25px" }}>
                  <div style={{
                    ...
                    <span style={{ fontWeight: "700", fontSize: "18px", color: "#fbbf24" }}>
                      📸 Photos
                    </span>
                    <span style={{ color: "#8b5cf6", fontSize: "13px" }}>
                      {content.filter(item => item.fileType === 'image').length} items
                    </span>
                  </div>
                  <div style={{
                    display: "flex",
                        ...
                        <div style={{
                          ...
                          {stickers.slice(0, 5).map((sticker, idx) => (
                            <button
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                sendStickerToContent(item.id, sticker);
                              }}
                              style={{
                                fontSize: "14px",
              ...
              {hasVideos && (
                <div style={{ marginTop: "25px" }}>
                  <div style={{
                    ...
                    <span style={{ color: "#8b5cf6", fontSize: "13px" }}>
                      {content.filter(item => item.fileType === 'video').length} items
                    </span>
                  </div>
                  <div style={{
                    display: "flex",
                    ...
                    {content.filter(item => item.fileType === 'video').map((item) => (
                      <div
                        ...
                        style={{
                          ...
                          borderRadius: "16px",
                          overflow: "hidden",
                          border: !subscription ? "2px solid #fbbf24" : "1px solid rgba(139, 92, 246, 0.3)",
                          flexShrink: 0,
                          position: "relative",
                          transition: "all 0.3s",
                  ...
                  {!subscription && (
                    <div style={{
                      ...
                      <span style={{ color: "#fbbf24", fontSize: "13px" }}>
                        🔒 <strong>Videos are locked.</strong> Upgrade to Premium to watch!
                      </span>
                    </div>
                  )}
                </div>
        ...
        <div style={{
              ...
              >
                <div style={{
                  ...
                  background: msg.from === "You"
                    ...
                    : "#1a1a2e",
                  maxWidth: "80%",
                  border: msg.from !== "You" ? "1px solid rgba(139, 92, 246, 0.2)" : "none",
                  ...
                  <div style={{
                    fontSize: "11px",
                    color: msg.from === "You" ? "rgba(255,255,255,0.7)" : "#94a3b8",
                    marginBottom: "4px",
                    fontWeight: "600",
                  }}>
                    {msg.from}
          ...
          <form onSubmit={handleSendMessage} style={{ display: "flex", gap: "10px" }}>
            <input
              ...
              onFocus={(e) => {
                e.target.style.borderColor = "#8b5cf6";
                e.target.style.boxShadow = "0 0 25px rgba(139, 92, 246, 0.2)";
              }}
              onBlur={(e) => {
      ...
      {popupContent && (
        ...
        >
          ...
          <div style={{
            ...
            {popupContent.stickers && (
              <span>🎨 {popupContent.stickers.length} stickers</span>
            )}
          </div>
